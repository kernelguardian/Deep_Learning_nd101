...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        hidden_outputs = self.activation(hidden_inputs) # signals from hidden layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        error = final_ouptuts-y # Output layer error is the difference between desired target and actual output.
        ...
        hidden_error_term = hidden_error * hidden_outputs * (1 - outputs)
